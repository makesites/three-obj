    ...
    compile: function( data ){ 
        ...
        */
        ...
        if( this.options.shading == "smooth" ){
            nnormals = data.normals.length;
        } else { 
            nnormals = 0;
        }
        
        
        ntri_flat = sfaces['triangles_flat'].length;
        ntri_smooth = sfaces['triangles_smooth'].length;
        ntri_flat_uv = sfaces['triangles_flat_uv'].length;
        ntri_smooth_uv = sfaces['triangles_smooth_uv'].length;
        
        nquad_flat = sfaces['quads_flat'].length;
        nquad_smooth = sfaces['quads_smooth'].length;
        nquad_flat_uv = sfaces['quads_flat_uv'].length;
        nquad_smooth_uv = sfaces['quads_smooth_uv'].length;
        ...
        */
        ndata = struct.pack('<IIIIIIIIIII', data.vertices.length,
                                   nnormals,
                                   data.uvs.length,
                                   ntri_flat,
                                   ntri_smooth,
        ...
        */
        if( this.options.shading == "smooth" ){ 
            for( var i in data.normals ){
                var n = data.normals[i];
                n = utils.normalize(n);
                var oct = struct.pack('<bbb', Math.floor(n[0]*127+0.5),
